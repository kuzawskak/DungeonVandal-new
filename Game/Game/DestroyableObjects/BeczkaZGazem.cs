...
namespace Game.DestroyableObjects
{
    ...
    /// </summary>
    class BeczkaZGazem: Map.MapObject, ReagujeNaGrawitacje, Przesuwalny, Zniszczalny,Eksplodujacy
    {
        ...
        /// </summary>
        private string asset_name = "Textures\\beczka";
        ...
        public BeczkaZGazem(ContentManager content, Rectangle rectangle, int x, int y):base(content,rectangle,x,y)
        {
            this.points = 30;
            TypeTag = Map.ElementType.BECZKAZGAZEM;
